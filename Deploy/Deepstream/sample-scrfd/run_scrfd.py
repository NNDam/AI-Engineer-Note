...
from parser_scrfd import nvds_infer_parse_scrfd
import pyds
import time
...
def add_obj_meta_to_frame(frame_object, frame_object_meta, batch_meta, frame_meta):
    ...
    txt_params.display_text = (
        "face " + "{:04.3f}".format(frame_object.detectionConfidence)
    )
    # Font , font-color and font-size
    ...
    # user_meta.user_meta_data = pyds.NvDsUserMeta.cast(4)
...
def main(args):
    ...
    pgie.set_property('config-file-path', "config_scrfd.txt")
